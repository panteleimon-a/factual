...
try:
    ...
    dataset = tf.keras.utils.get_file(fname="aclImdb_v1.tar.gz",origin=data_dir,untar=True,cache_dir='.',cache_subdir='')
...
main_dir = os.path.join(os.path.dirname(dataset), '/fine_tune_data')
